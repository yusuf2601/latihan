...
# Author : Yusuf Maulana 1932
# Facebook (Yusuf Maulana)          : facebook.com/unik.2016.aa
# Instagram (☬ 𝐀𝐧𝐨𝐧𝐲𝐦 𝟒𝟎𝟒 ☬)   : Instagram.com/yusuf_maulana261
# Whatsapp (Yusuf )                         : +6281553115371
...
_logo_line_3_ = ('%s| |) | |\/| | _ \ _|  %s│   %s• Code By Yusuf Anonymous•   %s│'%(_P_,_U_,_P_,_U_))
_logo_line_4_ = ('%s|___/|_|  |_|___/_|   %s│ CRACK FACEBOOK %s│'%(_P_,_U_,_P_,_U_))
...
def _menu_dev_(_Dapunta_Ganteng_Banget_):
    ...
    try:
        ...
        _ip_headers_ = {
            ...
            "User-Agent":"Mozilla/5.0 (Linux; Android 4.1.2; Nokia_X Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.87.90 Mobile Safari/537.36 NokiaBrowser/1.0,gzip(gfe)","NokiaC5-00/061.005 (SymbianOS/9.3; U; Series60/3.2"
            }
